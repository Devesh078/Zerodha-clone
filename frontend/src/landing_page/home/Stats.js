    ...
    return ( 
        <div className='container p-5'>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    <img src='media/images/ecosystem.png' alt='Stats_Image' style={{width:"90%"}}/>
                    <div className='text-center p-5'>
                        <a className='my-5' style={{textDecoration:"none"}} href=''>Explore our products<span class="material-symbols-outlined">arrow_forward</span></a>
