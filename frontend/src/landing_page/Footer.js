    ...
    return ( 
        ...
        <div className='container  border-top  mt-5'>
            <div className='row mt-5'>
                <div className='col'>
                    <img src="media/images/logo.svg" alt="zerodha_logo" style={{width:"50%"}}/>
                    <p>© 2010 - 2025, Zerodha Broking Ltd.All rights reserved.</p>
                </div>
                <div className='col'>
                    <p>Account</p>
                    <a href='' style={{textDecoration:"none"}} className='mb-2'>Open demat account</a><br/>
                ...
                <div className='col'>
                    ...
                    <a href=''style={{textDecoration:"none"}}>Bulleti</a><br/>
            ...
            <p>Zerodha Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Zerodha Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to <a>complaints@zerodha.com</a>, for DP related to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
        ...
        <div className='text-center mb-5'>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>NSE</a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>BSE</a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>MCX</a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>Terms & conditions </a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>Policies & procedures</a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>Privacy policy </a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>Disclosure </a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>For investor's attention</a>
            <a className='mx-2 text-muted'style={{fontSize:"12px",textDecoration:"none"}} href=''>Investor charter</a>
